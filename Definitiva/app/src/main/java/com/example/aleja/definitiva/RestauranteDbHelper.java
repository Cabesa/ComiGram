...
public class RestauranteDbHelper extends SQLiteOpenHelper {
    ...
    private void mockData(SQLiteDatabase sqLiteDatabase) {
        mockRestaurante(sqLiteDatabase, new Restaurante("American Restaurant", "Americano", "Es una pasada, atienden muy bien y la comida muy buena.", "Foto1", "5", "37.399905", "-5.925305"));
        mockRestaurante(sqLiteDatabase, new Restaurante("La torre de PIZZA", "Italiano", "He pedido una pizza y estaba muy buena, pero ha tardado un poco.", "Foto2", "3.5", "37.404661", "-5.994504"));
